...
\newcommand{\name}{Shivani Gupta} % Your Name
\newcommand{\course}{Bachelor Of Technology} % Your Program
\newcommand{\roll}{2004107} % Your Roll No.
\newcommand{\phone}{8840542075} % Your Phone Number
\newcommand{\emaila}{shivani2023gupta@gmail.com} %Email 1
\newcommand{\emailb}{shivanig.ug20.ece@nitp.ac.in} %Email 2
...
\begin{tabularx}{\linewidth}{L r} \\
  ...
  {Electronics and Communication Engineering} &  \href{https://github.com/shivanigupta12}{\raisebox{0.0\height}{\footnotesize \faGithub}\ {GitHub Profile}} \\
  {National Institute Of Technology, Patna} & \href{https://www.linkedin.com/in/shivani-gupta-b5130421a/}{\raisebox{0.0\height}{\footnotesize \faLinkedin}\ {LinkedIn Profile}}
\end{tabularx}
}
% \parbox{3.0cm}{%
...
\section{\textbf{Education}}
  \resumeSubHeadingListStart
    \resumeSubheading
      {National Institute Of Technology, Patna}{CGPA/Percentage: 8.75}
      {Bachelor Of Technology, Electronics and Communication Engineering}{Year}
    \resumeSubheading
